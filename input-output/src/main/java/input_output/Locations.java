    ...
    public static void main(String[] args) throws IOException {
        try (
            ...
            for (Location location : locations.values()) {
                locFile.write(location.getLocationID() + "," + location.getDescription() + System.lineSeparator());
                for (String direction : location.getExits().keySet()) {
                    if (!direction.equalsIgnoreCase("Q")) {
                        dirFile.write(location.getLocationID() + "," + direction + "," + location.getExits().get(direction) + System.lineSeparator());
                    }
                }
            }
        }
